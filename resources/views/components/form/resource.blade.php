...
<form action="{{ $action }}" method="POST" enctype="multipart/form-data" novalidate class="p-3">
    ...
    <div class="mb-3">
        <div class="mb-3">
            ...
            <input type="text" name="techArea" id="add__tech-area" class="form-control fw-light"
    ...
    <div class="mb-3">
        ...
        <input type="text" name="course" id="add__course" class="form-control fw-light"
    ...
    <div class="mb-3">
        ...
        <input type="text" name="discipline" id="add__discipline" class="form-control fw-light"
    ...
    <div class="mb-3">
        ...
        <textarea rows="6" name="description" id="add__description" class="form-control fw-light"> {{ old('description', $resource->description ?? '') }}</textarea>
    </div>
    <!-- END DESCRICAO -->
    ...
    <div class="mb-3">
        ...
        <input type="file" accept=".zip, .pdf, audio/*" name="file" required id="add__file"
            class="form-control fw-light @error('file') is-invalid @enderror" data-js="inputFile" />
    ...
    <div class="mb-3">
        ...
        <input type="text" name="tags" id="add__tags" class="form-control fw-light"
    ...
    <div class="mb-3">
        ...
        <label for="add__image" class="d-block p-5 rounded-2 add-image__box" data-js="boxImageDragAndDrop">
